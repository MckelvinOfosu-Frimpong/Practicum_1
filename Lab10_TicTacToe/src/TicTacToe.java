    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            for (int i = 0; i < 9; i++) {
                ...
                do
                {
                    row = SafeInput.getRangedInt(in, "Type your row coordinate", 1, 3) - 1;
                    col = SafeInput.getRangedInt(in, "Type your column coordinate", 1, 3) - 1;
                }
                ...
                if (moves >= 5) {
                    ...
                    {
                        System.out.printf("Game Over, %s wins!", currentPlayerString);
                        System.out.println(" ");
                        break;
                    }
                    else if (moves >= 7)
